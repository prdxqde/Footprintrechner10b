...
if (document.getElementById('3.5').checked) {
    score = score - 0.25;
   }
//Frage 4
...
if (document.getElementById('9.5').checked) {
    score = score + 0.00;
}
//Frage 10
...
if (document.getElementById('13.8').checked) {
    score = score - 0.01;
   }
//Frage 14
...
if (document.getElementById('14.9').checked) {
 score = score - 0.02;
}
//Frage 15
...
if (document.getElementById('16.5').checked) {
 score = score + 0.00;
}
//Frage 17
...
if (document.getElementById('18.10').checked) {
 score = score + 0.26;
}
//Frage 19
...
erg = Math.round (score * 100) / 100;

document.getElementById("erg").innerHTML = erg;
document.getElementById("ergb").innerHTML = erg;
